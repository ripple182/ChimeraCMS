...
<%--
    ...
    [#Default_Value_Slide_4_Image#]= [CHIMERA_VALUE_DEFAULT_IMAGE]
    [#Default_Value_Slide_4_Description#]= [CHIMERA_VALUE_DESCRIPTION_SMALL]
    [#Default_Value_Slide_4_ClientName#]= [CHIMERA_VALUE_TITLE_SMALL]
    [#Default_Value_Slide_4_ClientSubtitle#]= [CHIMERA_VALUE_TITLE_SMALL]
    [#Default_Value_Slide_5_Image#]= [CHIMERA_VALUE_DEFAULT_IMAGE]
    [#Default_Value_Slide_5_Description#]= [CHIMERA_VALUE_DESCRIPTION_SMALL]
    [#Default_Value_Slide_5_ClientName#]= [CHIMERA_VALUE_TITLE_SMALL]
    [#Default_Value_Slide_5_ClientSubtitle#]= [CHIMERA_VALUE_TITLE_SMALL]
--%>
