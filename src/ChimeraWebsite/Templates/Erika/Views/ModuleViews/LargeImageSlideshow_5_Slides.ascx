...
<%--
    [#Display_Name#]= 5 Slided Slideshow
    [#Display_Description#]= #
    ...
    [#Default_Value_Slide_5_CaptionBox#]= [CHIMERA_VALUE_EMPTY_TOGGLE]
    [#Default_Value_Slide_5_Title#]= Title
    [#Default_Value_Slide_5_Description#]= [CHIMERA_VALUE_DESCRIPTION_MEDIUM]
    [#Default_Value_Slide_5_Image#]= [CHIMERA_VALUE_DEFAULT_IMAGE_WIDE]
--%>
